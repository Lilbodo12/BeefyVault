 ...
 * This file demonstrates how to integrate Beefyvault with a web frontend
 */

// For React/Vue/Angular applications
export class BeefyvaultClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BeefyvaultClient(provider, contractAddress);
